...
def index():
    ...
    if request.method == 'GET':
        ...
        return render_template("index.html", value1=int(vote1), value2=int(vote2), value3=int(vote3), value4=int(vote4), button1=button1, button2=button2, button3=button3, button4=button4, title=title)
